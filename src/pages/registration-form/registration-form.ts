...
import greetings from "./registration_form-template.ts"



export interface RegistrationFormBlockType {}

class RegistrationForm extends Block<RegistrationFormBlockType> {
  constructor(props: RegistrationFormBlockType) {
    super('div', props);
  }
  ...
  addChildren() {
    ...
    this.children.registrationForm = registrationForm
  }
